...
export function AuthStateProvider({ children }) {
    ...
    const [walletIndex, setWalletIndex, connectWallet, address, connected, network, sendBitcoin, balance] = useMultiWallet();
    ...
    return (
        <AuthContext.Provider
            value={{
                walletContext: { walletIndex, setWalletIndex, connectWallet, address, connected, network, sendBitcoin, balance, walletList, setWalletList },
